...
const Button: React.ForwardRefRenderFunction<HTMLButtonElement, ButtonProps> = (
  ...
  const styleClass = clsx(
    ...
    'flex flex-nowrap items-center justify-center',
    {
      ...
      'rounded-lg hover:elevation-2': isContained && !link,
      'focus:bg-primary-dark/80': isContained && !link,
      'text-white active:border-primary-light': isContained && !link,
      'border-transparent rounded-lg bg-secondary text-white': link,
      'hover:bg-secondary-light active:border-border-col': link,
      'focus:bg-secondary-light': link,
      'w-full': fullWidth,
      'border-transparent rounded-full focus:bg-primary/20': isIcon,
      ...
      'focus:bg-primary-light/10': isOutlined,
    },
    className,
  )
