          ...
          <div className="md:col-span-3 col-span-full">
            ...
            <section className="mt-3">
              ...
              <Tab.Group>
                ...
                <Tab.Panels className="bg-slate-200 p-3 rounded-b-lg rounded-r-lg border border-solid border-gray-300">
                  <Tab.Panel>
                    ...
                    <div className="grid grid-cols-6 gap-6">
                      <div className="col-span-8 md:col-span-2 shadow-xl border-solid border-x border-b rounded-lg hover:shadow-2xl bg-white">
                        <Link href="/">
                          <a>
                            ...
                            <section className="p-3">
                              ...
                              <p className="text-sm md:text-base line-clamp-3">
                                ...
                                medical sciences with particular focus on
                                diseases in the Middle East and North Africa.
                              </p>
                  ...
                  <Tab.Panel>
                    ...
                    <div className="grid grid-cols-6 gap-6">
                      <div className="col-span-8 md:col-span-2 shadow-xl border-solid border-x border-b rounded-lg hover:shadow-2xl">
                        <Link href="/">
                          <a>
                            <div className="relative h-40">
                              <Image
